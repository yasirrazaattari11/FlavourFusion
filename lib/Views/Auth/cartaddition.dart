...
import 'package:flavour_fusion/Views/Widgets/Meals/add_to_cart.dart';
...
class CartMealBType extends StatefulWidget {
  const CartMealBType({super.key});

  @override
  State<CartMealBType> createState() => _CartMealBTypeState();
}

class _CartMealBTypeState extends State<CartMealBType> {
            ...
            Column(
              children: [
                SingleChildScrollView(scrollDirection: Axis.horizontal,
                    child: GestureDetector(child: CartAdd(mainText: 'Starter', subtext: 'Omelet with Salad', image: 'assets/images/mealBstarter.jpg', price: '150 PKR'),onTap: (){
                      Navigator.pop(context);
                    },)
                ),
              /* MealType(
                ...
                GestureDetector(
                  child: MealType(
                      ...
                      price: '150 PKR'),
                  onTap: (){
                    Navigator.push(context, PageTransition(child: CartMealBMain(), type: PageTransitionType.fade));
                  },
                ),
                SizedBox(
                  height: 30,
                ...
                GestureDetector(
                  child: MealType(
                      ...
                      price: '150 PKR'),
                  onTap: (){
                    Navigator.push(context, PageTransition(child:CardMealBDessert(), type: PageTransitionType.fade));
                  },
                ),
              ],
            ),
