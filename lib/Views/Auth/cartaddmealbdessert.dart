...
class CardMealBDessert extends StatefulWidget {

  @override
  State<CardMealBDessert> createState() => _CardMealBDessertState();
}

class _CardMealBDessertState extends State<CardMealBDessert> {
  @override
              ...
              children: [
                GestureDetector(
                  child: MealType(
                      ...
                      price: '150 PKR'),
                  onTap: (){
                    Navigator.pushReplacement(context, PageTransition(child: CartMealBType(), type: PageTransitionType.fade));
                  },
                ),
                SizedBox(
                  height: 30,
                ...
                price: '150 PKR'),
                   onTap: (){
                     Navigator.pushReplacement(context, PageTransition(child: CartMealBMain(), type: PageTransitionType.fade));
                   },
                 ),
                SizedBox(
                  height: 30,
                ...
                SingleChildScrollView(scrollDirection: Axis.horizontal,
                    child: CartAdd(mainText: 'Dessert', subtext: 'Omelet wit oranges', image: 'assets/images/mealBdessert.jpg', price: '150 PKR')
                ),
               /* MealType(
                    mainText: 'Dessert',
