...
class CartMealBMain extends StatefulWidget {

  @override
  State<CartMealBMain> createState() => _CartMealBMainState();
}

class _CartMealBMainState extends State<CartMealBMain> {
  @override
              ...
              children: [
                GestureDetector(
                  child: MealType(
                     ...
                     price: '150 PKR'),
                  onTap: (){
                    Navigator.push(context, PageTransition(child: CartMealBType(), type: PageTransitionType.fade));
                  },
                ),
                SizedBox(
                  height: 30,
                ...
                SingleChildScrollView(scrollDirection: Axis.horizontal,
                    child: GestureDetector(child: CartAdd(mainText: 'Main Course', subtext: 'Omelet with Water melon', image: 'assets/images/mealB.jpg', price: '150 PKR'),onTap: (){
                      Navigator.pop(context);
                    },)
                ),
               // MealType(
