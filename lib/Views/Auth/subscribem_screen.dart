        ...
        child: Column(
          children: [
                ...
                Container(
                  child: FlutterSwitch(
                    ...
                    onToggle: (val) {
                      setState(() {
                        status = val;
                        Navigator.pushReplacement(context, PageTransition(child: SubscribeWeek(), type: PageTransitionType.fade));
                      });
                    },
                    width: 80,
                    height: 35,
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Text('Save up to 59%', style:  GoogleFonts.poppins(
                ...
                SizedBox(width: 20,),
                Container(
                  child: Image.asset('assets/images/uparrow.png',color: Colors.deepOrange,),
                )
              ],
            ),
            SizedBox(height: 50,),
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text('4500 PKR', style: GoogleFonts.poppins(
                        color: Colors.deepOrange,
                        fontWeight: FontWeight.w300,
                        fontSize: 20,
                    ...
                    Padding(
                      ...
                      child: Text('1845 PKR', style: GoogleFonts.poppins(
                          color: Colors.black,
                    ...
                    SizedBox(height: 10,),
                    Text('Paid Monthly', style: GoogleFonts.poppins(
                        color: Colors.black,
                        fontWeight: FontWeight.w300,
                        fontSize: 16,
                    ),
