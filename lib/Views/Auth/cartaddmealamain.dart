...
class CartMealAMain extends StatefulWidget {

  @override
  State<CartMealAMain> createState() => _CartMealAMainState();
}

class _CartMealAMainState extends State<CartMealAMain> {
  @override
            ...
            Column(
              children: [
                ...
                SingleChildScrollView(scrollDirection: Axis.horizontal,
                    child: GestureDetector(child: CartAdd(mainText: 'Main Course', subtext: 'Fried Egg Bread, Juice', image: 'assets/images/mealA.jpg', price: '150 PKR'),onTap: (){
                      Navigator.pop(context);
                    },)
                ),
               /* MealType(
