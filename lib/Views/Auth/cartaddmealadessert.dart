...
import '../Widgets/Meals/add_to_cart.dart';
import '../Widgets/Meals/meal_buttons.dart';
import '../Widgets/Meals/meal_type.dart';
import '../Widgets/Meals/meal_view.dart';
import 'delivery_screen.dart';
import 'forgotpassword_screen.dart';
class CartMealADessert extends StatefulWidget {

  @override
  State<CartMealADessert> createState() => _CartMealADessertState();
}

class _CartMealADessertState extends State<CartMealADessert> {
  @override
              ...
              children: [
                ...
                GestureDetector(
                  child: MealType(
                      ...
                      price: '150 PKR'),
                  onTap: (){
                    Navigator.push(context, PageTransition(child: CartMealAStarter(), type: PageTransitionType.fade));
                  },
                ),
                SizedBox(
                  height: 30,
                ...
                GestureDetector(
                  child: MealType(
                      ...
                      price: '150 PKR'),
                  onTap: (){
                    Navigator.push(context, PageTransition(child: CartMealAMain(), type: PageTransitionType.fade));
                  },
                ),
                SizedBox(
                  height: 30,
                ...
                SingleChildScrollView(scrollDirection: Axis.horizontal,
                    child: GestureDetector(child: CartAdd(mainText: 'Dessert', subtext: 'Fried Egg Bread, Fruit', image: 'assets/images/mealAdessert.jpg', price: '150 PKR'),onTap: (){
                      Navigator.pop(context);
                    },)
                ),
              /*  MealType(
