...
class CartMealAStarter extends StatefulWidget {

  @override
  State<CartMealAStarter> createState() => _CartMealADessertState();
}

class _CartMealADessertState extends State<CartMealAStarter> {
  @override
            ...
            Column(
              children: [
                SingleChildScrollView(scrollDirection: Axis.horizontal,
                    child: GestureDetector(child: CartAdd(mainText: 'Starter', subtext: 'Fried Egg Bread, Jam', image: 'assets/images/mealAstart.jpg', price: '150 PKR'),onTap: (){
                      Navigator.pop(context);
                    },)
                ),
              /*  MealType(
                ...
                GestureDetector(
                  child: MealType(
                      ...
                      price: '150 PKR'),
                  onTap: (){
                    Navigator.push(context, PageTransition(child: CartMealADessert(), type: PageTransitionType.fade));
                  },
                ),
              ],
            ),
